...
- `openssh-to-server.js`: will instantiate an ssh2js server that accepts mlkem768x25519-sha256 as KEX algorithm. Then, it'll instantiate an openssh10.1 client that connects to it. This test will wait for user input so the client can use password authentication.
...
<img width="758" height="654" alt="image" src="https://github.com/user-attachments/assets/1e56d3b3-cdcb-4523-b004-a64bfaf182ad" />
