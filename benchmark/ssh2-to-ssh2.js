...
const keyPath = '/tmp/bench_host_key_ssh2';
...
async function main() {
  console.log('=== Scenario A — ssh2.js <-> ssh2.js ===');
  ...
  console.log('  curve25519:      KEXDH_INIT=32B,   KEXDH_REPLY=32B');
  console.log('  mlkem768x25519:  KEX_HYBRID_INIT=1216B, KEX_HYBRID_REPLY=1120B');
}
